//! Configuration for the Candle Adapter

use serde::{Deserialize, Serialize};

/// Configuration for CandleAdapter
///
/// Controls inference parameters and behavior for the Candle-based adapter.
///
/// # Example
///
/// ```rust
/// use ml_crate_dsrs::adapters::candle::CandleConfig;
///
...
mod tests {
    ...
    fn test_default_config() {
        let config = CandleConfig::default();
        assert_eq!(config.model_name, "candle-qwen2.5-0.5b");
    ...
    fn test_config_builder() {
        let config = CandleConfig::new("custom-model")
